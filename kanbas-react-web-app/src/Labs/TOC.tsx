    ...
    return (
        <div>
            <ul>
                ...
                <li><a id="wd-a5" href="#/Labs/Lab5">Lab 5</a></li>
                <li><a id="wd-k" href="#/Kanbas">Kanbas</a></li>
                <li> <a id="wd-github" href="https://github.com/chenyumao/chenyu-kanbas-react-web-app.git">GitHub</a></li>
            </ul>
                <p>Full Name: chenyu mao</p>
        </div>
    );
}
